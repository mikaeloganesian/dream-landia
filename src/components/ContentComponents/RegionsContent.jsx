    ...
    return (
        <div id="RegionsMenuHook" className="regionsContent">
            <div className="regionsText">
                ...
                <div className="regionsDescription">Признанный во всем мире как одно из ведущих мест отдыха, Бали предлагает уникальное сочетание тропического образа жизни и западных стандартов в области жилья, досуга и развлечений</div>
            </div>
